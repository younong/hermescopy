...
- media kinds ← the capability registry
...
from hermes_cli.model_plane.kinds import MEDIA_KINDS


def chat_catalog() -> list[dict[str, Any]]:
    """Return the chat provider catalog without network discovery."""
...
def capability_catalog(kind: str) -> list[dict[str, Any]]:
    """Return the media catalog rows for one kind (image/video/voice/vector)."""
