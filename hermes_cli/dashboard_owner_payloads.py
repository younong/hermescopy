...
# Compatibility aliases retained for legacy callers (dashboard_auth test
# fixtures and web_server modules that imported these names from this file).
safe_dashboard_relpath = safe_plugin_relpath
safe_plugin_api_relpath = safe_plugin_relpath
...
FONT_CHOICES = frozenset({
    ...
    "spectral", "fraunhofer-serif", "source-serif",
