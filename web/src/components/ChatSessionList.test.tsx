...
describe("ChatSessionList", () => {
  ...
  it("soft deletes a listed session and keeps physical deletion unused", async () => {
    ...
    expect(dialog?.textContent).toContain("keeping all stored messages");
    expect(dialog?.classList.contains("gui-chat-workspace-dialog")).toBe(true);
    expect(dialog?.closest("[data-gui-chat]")).not.toBeNull();
