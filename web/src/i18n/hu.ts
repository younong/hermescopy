...
export const hu: Translations = {
  ...
  cron: {
    ...
    editor: {
      modeLabel: "Futtatás mint",
      modeEmployee: "AI munkatárs",
      modeCustom: "Egyéni",
      employee: "AI munkatárs",
      employeePlaceholder: "Válassz munkatársat",
      employeesEmpty: "Még nincs aktív munkatárs. Hozz létre egyet a Munkatársak alatt, vagy válts Egyénire.",
      model: "Modell",
      modelDefault: "Alapértelmezett (jelenlegi modell)",
      skills: "Skillek (opcionális)",
      skillsEmpty: "Nincsenek skillek telepítve ehhez a profilhoz.",
      skillsHint: "A kiválasztott skillek a prompt futtatása előtt töltődnek be — a cron határozza meg a mikor, a skill a hogyan-t.",
      advanced: "Speciális",
      baseUrl: "Base URL felülírás",
      baseUrlPlaceholder: "https://api.example.com/v1",
      noAgent: "no_agent: csak a script fut, stdout változatlanul kézbesítve",
      script: "Script",
      scriptPlaceholder: "relativ/utvonal/a/scripts-ben",
      workdir: "Munkakönyvtár",
      workdirPlaceholder: "/abszolut/projekt/utvonal",
      contextFrom: "context_from job-azonosítók",
      contextFromPlaceholder: "soronként egy job-azonosító",
      toolsets: "enabled_toolsets",
      toolsetsEmpty: "Nincsenek elérhető toolsetek.",
    },
  },
