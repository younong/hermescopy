...
export const ja: Translations = {
  ...
  cron: {
    ...
    editor: {
      ...
      modeCustom: "カスタム",
      employee: "AI 従業員",
      employeePlaceholder: "従業員を選択",
      employeesEmpty: "アクティブな従業員がいません。「従業員」で作成するか、カスタムに切り替えてください。",
      model: "モデル",
      modelDefault: "デフォルト（現在のモデル）",
      skills: "スキル（任意）",
      skillsEmpty: "このプロファイルにインストールされたスキルはありません。",
      skillsHint: "選択したスキルはプロンプト実行前に読み込まれます——cron は「いつ」を、スキルは「どうやって」を決めます。",
      advanced: "詳細設定",
      baseUrl: "Base URL の上書き",
      baseUrlPlaceholder: "https://api.example.com/v1",
      noAgent: "no_agent: スクリプトのみ実行し stdout をそのまま配信",
      script: "スクリプト",
      scriptPlaceholder: "scripts 内の相対パス",
      workdir: "作業ディレクトリ",
      workdirPlaceholder: "/absolute/project/path",
      contextFrom: "context_from ジョブ ID",
      contextFromPlaceholder: "1 行に 1 ジョブ ID",
      toolsets: "enabled_toolsets",
      toolsetsEmpty: "利用可能なツールセットはありません。",
    },
  },
