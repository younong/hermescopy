...
export const zhHant: Translations = {
  ...
  cron: {
    ...
    editor: {
      ...
      modeCustom: "自訂",
      employee: "AI 員工",
      employeePlaceholder: "選擇員工",
      employeesEmpty: "尚無可用員工。請在「員工」頁建立,或切換到自訂。",
      model: "模型",
      modelDefault: "預設(目前模型)",
      skills: "技能(可選)",
      skillsEmpty: "此設定下未安裝技能。",
      skillsHint: "所選技能會在提示詞運行前載入——排程決定何時運行,技能決定如何執行。",
      advanced: "進階選項",
      baseUrl: "Base URL 覆寫",
      baseUrlPlaceholder: "https://api.example.com/v1",
      noAgent: "no_agent:僅運行腳本並原樣投遞 stdout",
      script: "腳本",
      scriptPlaceholder: "scripts 下的相對路徑",
      workdir: "工作目錄",
      workdirPlaceholder: "/absolute/project/path",
      contextFrom: "context_from 任務 ID",
      contextFromPlaceholder: "每行一個任務 ID",
      toolsets: "enabled_toolsets",
      toolsetsEmpty: "無可用工具集。",
    },
  },
