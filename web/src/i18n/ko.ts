...
export const ko: Translations = {
  ...
  cron: {
    ...
    editor: {
      ...
      employeesEmpty: "활성 직원이 없습니다. 직원 페이지에서 만들거나 사용자 지정으로 전환하세요.",
      model: "모델",
      modelDefault: "기본값 (현재 모델)",
      skills: "스킬 (선택 사항)",
      skillsEmpty: "이 프로필에 설치된 스킬이 없습니다.",
      skillsHint: "선택한 스킬은 프롬프트 실행 전에 로드됩니다 — cron은 언제를, 스킬은 어떻게를 정합니다.",
      advanced: "고급",
      baseUrl: "Base URL 재정의",
      baseUrlPlaceholder: "https://api.example.com/v1",
      noAgent: "no_agent: 스크립트만 실행하고 stdout을 그대로 전달",
      script: "스크립트",
      scriptPlaceholder: "scripts 내 상대 경로",
      workdir: "작업 디렉터리",
      workdirPlaceholder: "/absolute/project/path",
      contextFrom: "context_from 작업 ID",
      contextFromPlaceholder: "줄마다 작업 ID 하나",
      toolsets: "enabled_toolsets",
      toolsetsEmpty: "사용 가능한 툴셋이 없습니다.",
    },
  },
