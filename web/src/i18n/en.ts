...
export const en: Translations = {
  ...
  cron: {
    ...
    editor: {
      modeLabel: "Run as",
      modeEmployee: "AI employee",
      modeCustom: "Custom",
      employee: "AI employee",
      employeePlaceholder: "Select an employee",
      employeesEmpty: "No active employees yet. Create one under Employees, or switch to Custom.",
      model: "Model",
      modelDefault: "Default (current model)",
      skills: "Skills (optional)",
      skillsEmpty: "No skills installed for this profile.",
      ...
      noAgent: "no_agent: run the script only and deliver stdout verbatim",
      script: "Script",
      ...
      toolsetsEmpty: "No toolsets available.",
    },
  },
  ...
  guiChat: {
    ...
    scheduledTasks: {
      ...
      employeeRequired: "Select an AI employee, or switch to Custom mode.",
      editDescription: "Update the task instructions, schedule, and how it runs.",
