...
export const en: Translations = {
  ...
  guiChat: {
    shell: {
      ...
      startEmployeeChat: "Start employee chat",
      chatWithEmployee: "Chat with employee",
      employeesLoading: "AI employees are loading.",
      employeesLoadFailed: "AI employees could not be loaded. Please refresh the page.",
      noEmployees: "No available AI employees. Please configure one in Employee management.",
