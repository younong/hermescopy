...
export const en: Translations = {
  ...
  guiChat: {
    ...
    scheduledTasks: {
      ...
      limitHint: "Each user can create up to 10 scheduled tasks.",
      limitReached: "You have reached the 10-task limit. Delete an existing task before creating another.",
      countLabel: "{count} / 10 scheduled tasks",
      noPrompt: "No prompt",
