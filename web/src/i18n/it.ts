...
export const it: Translations = {
  ...
  cron: {
    ...
    editor: {
      modeLabel: "Esegui come",
      modeEmployee: "Dipendente IA",
      modeCustom: "Personalizzato",
      employee: "Dipendente IA",
      employeePlaceholder: "Seleziona un dipendente",
      employeesEmpty: "Nessun dipendente attivo. Creane uno in Dipendenti o passa a Personalizzato.",
      model: "Modello",
      modelDefault: "Predefinito (modello attuale)",
      skills: "Skill (opzionale)",
      skillsEmpty: "Nessuna skill installata per questo profilo.",
      skillsHint: "Le skill selezionate vengono caricate prima dell'esecuzione del prompt — il cron decide quando, la skill decide come.",
      advanced: "Avanzate",
      baseUrl: "Override Base URL",
      baseUrlPlaceholder: "https://api.example.com/v1",
      noAgent: "no_agent: esegue solo lo script e consegna stdout verbatim",
      script: "Script",
      scriptPlaceholder: "percorso/relativo/in/scripts",
      workdir: "Directory di lavoro",
      workdirPlaceholder: "/percorso/assoluto/progetto",
      contextFrom: "ID job context_from",
      contextFromPlaceholder: "un id job per riga",
      toolsets: "enabled_toolsets",
      toolsetsEmpty: "Nessun toolset disponibile.",
    },
  },
