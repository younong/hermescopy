...
export const es: Translations = {
  ...
  cron: {
    ...
    editor: {
      modeLabel: "Ejecutar como",
      modeEmployee: "Empleado de IA",
      modeCustom: "Personalizado",
      employee: "Empleado de IA",
      employeePlaceholder: "Selecciona un empleado",
      employeesEmpty: "Aún no hay empleados activos. Crea uno en Empleados o cambia a Personalizado.",
      model: "Modelo",
      modelDefault: "Predeterminado (modelo actual)",
      skills: "Skills (opcional)",
      skillsEmpty: "No hay skills instaladas para este perfil.",
      skillsHint: "Las skills seleccionadas se cargan antes de ejecutar el prompt: el cron decide cuándo, la skill decide cómo.",
      advanced: "Avanzado",
      baseUrl: "Anulación de Base URL",
      baseUrlPlaceholder: "https://api.example.com/v1",
      noAgent: "no_agent: ejecuta solo el script y entrega stdout literalmente",
      script: "Script",
      scriptPlaceholder: "ruta/relativa/en/scripts",
      workdir: "Directorio de trabajo",
      workdirPlaceholder: "/ruta/absoluta/del/proyecto",
      contextFrom: "IDs de job en context_from",
      contextFromPlaceholder: "un id de job por línea",
      toolsets: "enabled_toolsets",
      toolsetsEmpty: "No hay toolsets disponibles.",
    },
  },
