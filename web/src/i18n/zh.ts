...
export const zh: Translations = {
  ...
  cron: {
    ...
    editor: {
      ...
      employeesEmpty: "暂无可用员工。请在“员工”页创建，或切换到自定义。",
      model: "模型",
      modelDefault: "默认（当前模型）",
      skills: "技能（可选）",
      skillsEmpty: "此配置下未安装技能。",
      skillsHint: "所选技能会在提示词运行前加载——定时决定何时运行，技能决定如何执行。",
      advanced: "高级选项",
      baseUrl: "Base URL 覆盖",
      baseUrlPlaceholder: "https://api.example.com/v1",
      noAgent: "no_agent：仅运行脚本并原样投递 stdout",
      script: "脚本",
      scriptPlaceholder: "scripts 下的相对路径",
      workdir: "工作目录",
      workdirPlaceholder: "/absolute/project/path",
      contextFrom: "context_from 任务 ID",
      contextFromPlaceholder: "每行一个任务 ID",
      toolsets: "enabled_toolsets",
      toolsetsEmpty: "无可用工具集。",
    },
  },
  ...
  guiChat: {
    ...
    collaboration: {
      ...
      unnamedEmployee: "未命名员工",
      aiEmployee: "AI 员工",
      builtinAssistant: "AI 助手",
      builtinDescription: "内置通用助手",
    ...
    scheduledTasks: {
      ...
      employeeRequired: "请选择 AI 员工，或切换到自定义模式。",
      scriptRequired: "no_agent 任务必须提供脚本。",
      editDescription: "更新任务说明、计划和运行方式。",
    ...
    employees: {
      ...
      builtinManaged: "此助手的模型、思考强度、工具、协作权限、生命周期和消息渠道由 Hermes 管理；你可以在此个性化其称呼、偏好和头像。",
      builtinPersonalizationHelp: "个性化内置助手的显示方式，以及它在新会话中遵循的偏好。",
      nickname: "昵称",
      nicknamePlaceholder: "AI 助手",
      nicknameRequired: "请输入昵称。",
      personalPreference: "个人偏好",
      personalPreferencePlaceholder: "例如：请简洁回答，并优先使用中文。",
      personalPreferenceHelp: "这些偏好仅作为新建或重建会话的指导，不能覆盖系统策略或安全控制。",
      savePersonalization: "保存个性化设置",
      personalizationSaved: "内置助手个性化设置已保存",
      personalizationSaveFailed: "无法保存内置助手个性化设置：{error}",
      avatarSaveFailed: "个性化设置已保存，但头像更新失败：{error}",
