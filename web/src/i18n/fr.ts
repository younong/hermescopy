...
export const fr: Translations = {
  ...
  cron: {
    ...
    editor: {
      modeLabel: "Exécuter en tant que",
      modeEmployee: "Employé IA",
      modeCustom: "Personnalisé",
      employee: "Employé IA",
      employeePlaceholder: "Sélectionner un employé",
      employeesEmpty: "Aucun employé actif. Créez-en un sous Employés ou passez en Personnalisé.",
      model: "Modèle",
      modelDefault: "Par défaut (modèle actuel)",
      skills: "Skills (optionnel)",
      skillsEmpty: "Aucune skill installée pour ce profil.",
      skillsHint: "Les skills choisies sont chargées avant l'exécution du prompt — le cron décide quand, la skill décide comment.",
      advanced: "Avancé",
      baseUrl: "Remplacement de Base URL",
      baseUrlPlaceholder: "https://api.example.com/v1",
      noAgent: "no_agent : exécute uniquement le script et livre stdout tel quel",
      script: "Script",
      scriptPlaceholder: "chemin/relatif/dans/scripts",
      workdir: "Répertoire de travail",
      workdirPlaceholder: "/chemin/absolu/du/projet",
      contextFrom: "IDs de job context_from",
      contextFromPlaceholder: "un id de job par ligne",
      toolsets: "enabled_toolsets",
      toolsetsEmpty: "Aucun toolset disponible.",
    },
  },
