...
export const tr: Translations = {
  ...
  cron: {
    ...
    editor: {
      modeLabel: "Şu şekilde çalıştır",
      modeEmployee: "YZ çalışanı",
      modeCustom: "Özel",
      employee: "YZ çalışanı",
      employeePlaceholder: "Bir çalışan seçin",
      employeesEmpty: "Henüz aktif çalışan yok. Çalışanlar altında bir tane oluşturun veya Özel'e geçin.",
      model: "Model",
      modelDefault: "Varsayılan (mevcut model)",
      skills: "Yetenekler (isteğe bağlı)",
      skillsEmpty: "Bu profil için yüklü yetenek yok.",
      skillsHint: "Seçilen yetenekler prompt çalışmadan önce yüklenir — cron ne zamanı, yetenek nasılı belirler.",
      advanced: "Gelişmiş",
      baseUrl: "Base URL geçersiz kılma",
      baseUrlPlaceholder: "https://api.example.com/v1",
      noAgent: "no_agent: yalnızca betiği çalıştır ve stdout'u aynen ilet",
      script: "Betik",
      scriptPlaceholder: "scripts/içinde/göreli/yol",
      workdir: "Çalışma dizini",
      workdirPlaceholder: "/mutlak/proje/yolu",
      contextFrom: "context_from iş ID'leri",
      contextFromPlaceholder: "satır başına bir iş id'si",
      toolsets: "enabled_toolsets",
      toolsetsEmpty: "Kullanılabilir araç seti yok.",
    },
  },
