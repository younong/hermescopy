...
export const ga: Translations = {
  ...
  cron: {
    ...
    editor: {
      modeLabel: "Rith mar",
      modeEmployee: "Fostaire AI",
      modeCustom: "Saincheaptha",
      employee: "Fostaire AI",
      employeePlaceholder: "Roghnaigh fostaire",
      employeesEmpty: "Níl aon fhostaire gníomhach ann fós. Cruthaigh ceann faoi Fostairí, nó athraigh go Saincheaptha.",
      model: "Múnla",
      modelDefault: "Réamhshocrú (múnla reatha)",
      skills: "Scileanna (roghnach)",
      skillsEmpty: "Níl scileanna suiteáilte don phróifíl seo.",
      skillsHint: "Luchtaítear na scileanna roghnaithe sula ritear an leid — socraíonn an cron cathain, socraíonn an scil conas.",
      advanced: "Casta",
      baseUrl: "Sárscriobh Base URL",
      baseUrlPlaceholder: "https://api.example.com/v1",
      noAgent: "no_agent: rith an script amháin agus seachad stdout díreach",
      script: "Script",
      scriptPlaceholder: "conair/choibhneasta/i/scripts",
      workdir: "Eolaire oibre",
      workdirPlaceholder: "/conair/absalóideach/tionscadal",
      contextFrom: "IDanna jab context_from",
      contextFromPlaceholder: "id jab amháin in aghaidh na líne",
      toolsets: "enabled_toolsets",
      toolsetsEmpty: "Níl aon toolsets ar fáil.",
    },
  },
