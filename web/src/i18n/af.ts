...
export const af: Translations = {
  ...
  cron: {
    ...
    editor: {
      modeLabel: "Loop as",
      modeEmployee: "KI-werknemer",
      modeCustom: "Pasgemaak",
      employee: "KI-werknemer",
      employeePlaceholder: "Kies 'n werknemer",
      employeesEmpty: "Nog geen aktiewe werknemers nie. Skep een onder Werknemers, of skakel oor na Pasgemaak.",
      model: "Model",
      modelDefault: "Verstek (huidige model)",
      skills: "Vaardighede (opsioneel)",
      skillsEmpty: "Geen vaardighede vir hierdie profiel geïnstalleer nie.",
      skillsHint: "Gekose vaardighede laai voor die prompt loop — die cron bepaal wanneer, die vaardigheid bepaal hoe.",
      advanced: "Gevorderd",
      baseUrl: "Base URL-oorskrywing",
      baseUrlPlaceholder: "https://api.example.com/v1",
      noAgent: "no_agent: voer net die skrip uit en lewer stdout woordeliks",
      script: "Skrip",
      scriptPlaceholder: "relatiewe/pad/in/scripts",
      workdir: "Werkgids",
      workdirPlaceholder: "/absolute/projek/pad",
      contextFrom: "context_from job-ID's",
      contextFromPlaceholder: "een job-id per reel",
      toolsets: "enabled_toolsets",
      toolsetsEmpty: "Geen gereedskapstelle beskikbaar nie.",
    },
  },
