  ...
  return (
    <div>
      ...
      <div className="mt-4 grid gap-3 border-l-2 border-[#e8eaed] pl-3 sm:grid-cols-2">
            ...
            <label className="flex items-center justify-between gap-3 text-xs"><span><span className="block font-medium">{text.allowCreateScheduledTasks}</span><span className="text-[#969aa1]">{text.allowCreateScheduledTasksHint}</span></span><Switch checked={collaborationPolicy.may_create_scheduled_tasks} className="gui-chat-skill-switch" onCheckedChange={(checked) => onCollaborationChange({ ...collaborationPolicy, may_create_scheduled_tasks: checked })} /></label>
