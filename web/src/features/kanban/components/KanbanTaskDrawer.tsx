...
import { formatBytes } from "@/features/gui-chat/attachments";
import { triggerDownload } from "@/features/gui-chat/files";
...
interface OverviewProps {
  ...
  setHomes: Dispatch<SetStateAction<KanbanHomeChannel[]>>;
...
interface RunsProps {
  ...
  profiles: string[];
  runAction: RunAction;
  setInspections: Dispatch<SetStateAction<Record<number, KanbanRunInspection>>>;
  setLog: Dispatch<SetStateAction<KanbanWorkerLog | null>>;
  task: KanbanTask;
}
