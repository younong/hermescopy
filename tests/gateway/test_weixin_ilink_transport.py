...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"ret": -2, "errmsg": "freq limit"}, "rate_limited", -2, True),
        ({"errcode": -14, "errmsg": "secret detail"}, "stale_session", -14, False),
        ({"ret": -2, "errmsg": "unknown error"}, "stale_context", -2, False),
        ({"ret": -2, "errmsg": ""}, "stale_context", -2, False),
        ({"ret": -2}, "stale_context", -2, False),
        ({"ret": -2, "errmsg": "context token expired"}, "stale_context", -2, False),
        ({"ret": -2, "errmsg": "invalid request"}, "provider_rejected", -2, False),
