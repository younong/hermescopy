    ...
    *,
    ...
    cli_obj.agent = SimpleNamespace(
        ...
        context_compressor=SimpleNamespace(
            ...
            calibrated_prompt_tokens=lambda _value: context_tokens,
            compression_count=compressions,
        ),
    )
    cli_obj.agent._prepared_model_request = prepare_model_request_snapshot(
        cli_obj.agent,
        request_id="status:1",
        payload={
            "model": cli_obj.model,
...
class TestCLIStatusBar:
    ...
    def test_observed_usage_does_not_replace_prepared_context(self):
        """Provider-observed usage never replaces prepared-request occupancy."""
        cli_obj = _attach_agent(
            _make_cli(),
            prompt_tokens=10_230,
            completion_tokens=2_220,
